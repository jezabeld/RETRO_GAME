...
*/
#ifndef HAPTICDRV_DRV2605_H_
#define HAPTICDRV_DRV2605_H_
...
HAL_StatusTypeDef drv2605_play_repeat(I2C_HandleTypeDef *hi2c,
                                      uint8_t effect_id,
                                      uint8_t reps,           // cuántas veces repetir
                                      uint16_t gap_ms);       // pausa entre repeticiones (0 = sin pausa)

HAL_StatusTypeDef drv2605_play_sequence_fixed(I2C_HandleTypeDef *hi2c,
                                              const uint8_t *effects, // p.ej. {1,1,1,1}
                                              uint8_t n,              // cantidad válida en 'effects'
                                              uint16_t gap_ms);       // pausa al terminar la secuencia
